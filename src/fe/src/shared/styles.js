/* scn, styled class names */
export const scn = {
  primaryButton:  'btn normal-case min-h-fit h-9 bg-teal-100 border-teal-400 text-teal-600 hover:bg-white hover:border-slate-200 m-0.5',
  ...
  input:          'border border-slate-200 rounded-md px-2 w-full',
  stepTitle:      'h-[6rem] text-left leading-[6rem]',
  stepSubtitle:   'absolute left-[3rem] top-0 text-slate-500 text-sm text-left align-top mt-16 leading-4',
};
